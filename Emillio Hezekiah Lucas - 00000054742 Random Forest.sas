...
proc casutil;
  Load casdata="Forest___sales_1.sashdat" incaslib="Models" casout="Forest___sales_1" outcaslib="casuser" replace;
Quit;
...
proc cas;
  ...
  routineCode = "
   ...
   Generated SAS Scoring Code
     ...
     ------------------------------------------*/
declare object Forest___sales_1(astore);
call Forest___sales_1.score('CASUSER','Forest___sales_1');
   /*------------------------------------------*/
   /*_VA_DROP*/ drop 'P_sales'n;
      'P_sales_879'n='P_sales'n;
   /*------------------------------------------*/
";
