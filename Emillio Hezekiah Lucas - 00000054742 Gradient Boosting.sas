...
proc casutil;
  Load casdata="Gradient_boosting___sales_1.sashdat" incaslib="Models" casout="Gradient_boosting___sales_1" outcaslib="casuser" replace;
Quit;
...
proc cas;
  ...
  routineCode = "
   ...
   Generated SAS Scoring Code
     ...
     ------------------------------------------*/
declare object Gradient_boosting___sales_1(astore);
call Gradient_boosting___sales_1.score('CASUSER','Gradient_boosting___sales_1');
   /*------------------------------------------*/
   /*_VA_DROP*/ drop 'P_sales'n;
      'P_sales_7045'n='P_sales'n;
   /*------------------------------------------*/
";
